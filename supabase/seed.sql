...
insert into public.tasks (id, title, description, category, reward, estimated_time, difficulty, instructions, requirements, max_completions, single_submission_per_user, status, created_by) values
  ('b0000000-0000-4000-8000-000000000001', 'Suivre et aimer notre page Instagram', 'Abonnez-vous à notre page Instagram officielle et aimez les 3 dernières publications.', 'SOCIAL_MEDIA', 75, '5 min', 'EASY', 'Suivez le compte puis envoyez une capture d''écran.', 'Compte Instagram public requis', 200, true, 'PUBLISHED', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000002', 'Rédiger un avis sur le Play Store', 'Laissez un avis honnête de 3 lignes minimum sur notre application mobile.', 'CONTENT', 100, '10 min', 'EASY', 'Publiez l''avis puis copiez le texte dans le formulaire de preuve.', 'Application installée', 150, true, 'PUBLISHED', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000003', 'Répondre à un sondage de 5 minutes', 'Sondage sur les habitudes numériques des jeunes africains.', 'SURVEYS', 50, '5 min', 'EASY', 'Répondez à toutes les questions du sondage.', 'Aucun', null, true, 'PUBLISHED', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000004', 'Partager notre publication en story', 'Partagez notre dernière publication en story WhatsApp ou Instagram pendant 24h.', 'SOCIAL_MEDIA', 60, '5 min', 'EASY', 'Envoyez une capture d''écran de la story active.', 'Minimum 50 contacts', 300, true, 'PUBLISHED', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000005', 'Tester la nouvelle fonctionnalité de paiement', 'Testez le flux de dépôt démo et signalez tout bug rencontré.', 'APP_TESTING', 250, '20 min', 'MEDIUM', 'Effectuez un dépôt démo et un retrait, notez vos observations.', 'Compte actif depuis 7 jours', 50, true, 'PUBLISHED', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000006', 'Créer une courte vidéo de présentation', 'Vidéo de 30 à 60 secondes présentant la plateforme sur TikTok ou Reels.', 'CONTENT', 400, '45 min', 'HARD', 'Publiez la vidéo puis envoyez le lien.', 'Compte public, minimum 200 vues', 20, true, 'PUBLISHED', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000007', 'Collecter 20 avis clients pour une étude', 'Interrogez 20 personnes de votre entourage sur leurs habitudes d''achat en ligne.', 'DATA', 300, '2 heures', 'MEDIUM', 'Compilez les réponses dans un document et envoyez le lien.', 'Modèle de questionnaire fourni', 30, true, 'PUBLISHED', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000008', 'Promouvoir notre offre sur un groupe communautaire', 'Publiez notre offre dans un groupe Facebook ou WhatsApp d''au moins 500 membres.', 'MARKETING', 150, '10 min', 'EASY', 'Envoyez une capture d''écran de la publication.', 'Groupe actif de 500+ membres', 40, true, 'PAUSED', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000009', 'Traduire une page produit en anglais', 'Traduisez le texte fourni du français vers l''anglais.', 'DIGITAL', 200, '30 min', 'MEDIUM', 'Le texte source est fourni au démarrage de la mission.', 'Bon niveau d''anglais', 15, true, 'PUBLISHED', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000010', 'Signaler des bugs sur l''application mobile', 'Explorez l''application et documentez tout bug rencontré.', 'APP_TESTING', 175, '30 min', 'MEDIUM', 'Décrivez chaque bug avec les étapes de reproduction.', 'Réservé aux testeurs vérifiés', 10, true, 'DRAFT', 'a0000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000011', 'Regarder 5 publicités partenaires', 'Visionnez 5 publicités courtes de nos partenaires jusqu''à la fin.', 'ADS', 25, '5 min', 'EASY', 'Regardez chaque publicité en entier, sans passer.', 'Aucun', null, false, 'PUBLISHED', 'a0000000-0000-4000-8000-000000000001'),
